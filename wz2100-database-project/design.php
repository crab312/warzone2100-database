...
$js_array = array_merge(scandir("data_icons/Weapon"), scandir("data_icons/Body"), scandir("data_icons/Propulsion"), scandir("data_icons/Propulsion"), scandir("data_icons/SupportTurrets"));
$js_hash_array = array();
